    ...
    public class WebApi
    {
        ...
        private void SetProxy()
        {
            ...
            catch (UriFormatException)
            {
                ...
                System.Windows.Forms.MessageBox.Show("The proxy server URI you used is invalid.\nVRCX will close, please correct the proxy URI.", "Invalid Proxy URI", System.Windows.Forms.MessageBoxButtons.OK);
                Environment.Exit(0);
            }
        }
